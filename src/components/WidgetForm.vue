    ...
    >
      ...
      >
        <template v-for="(element, index) in data.list">
          ...
          <template v-if="element.islayout">
            <component :is='element.type' :element="element" :index="index" :data="data" :key="element.key" :select.sync="selectWidget">
          </component>
          </template>
          <!-- <template v-else-if="element.type == 'ThreeColumns'">
            <three-columns :element="element" :index="index" :data="data" :key="element.key" :select.sync="selectWidget"></three-columns>
          </template> -->
          <template v-else>
            <widget-form-item
              v-if="element && element.key"
...
export default {
  ...
  methods: {
    ...
    handleWidgetAdd(evt) {
      ...
      if (this.data.list[newIndex].islayout && this.data.list[newIndex].name != 'div') {
        this.$set(this.data.list, newIndex, {
          ...this.data.list[newIndex],
