...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_1m5739fcjnlpb1z9.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_1m5739fcjnlpb1z9.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_1m5739fcjnlpb1z9.getSelectorConverter(editor)) {
      selectorConverter = $_1m5739fcjnlpb1z9.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_1m5739fcjnlpb1z9.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_1m5739fcjnlpb1z9.getCssGroups(editor));
      ...
      if (!$_1m5739fcjnlpb1z9.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_1m5739fcjnlpb1z9.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_5277wff7jnlpb1yy.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_fqjiouf6jnlpb1yv = { get: get };

  global.add('importcss', function (editor) {
    $_5277wff7jnlpb1yy.setup(editor);
    return $_fqjiouf6jnlpb1yv.get(editor);
  });
  function Plugin () {
  }
